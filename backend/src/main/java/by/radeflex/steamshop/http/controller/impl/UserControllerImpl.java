...
import by.radeflex.steamshop.http.controller.UserController;
...
public class UserControllerImpl implements UserController {
    ...
    @GetMapping
    public ResponseEntity<PageResponse<UserReadDto>> findAll(UserFilter filter, Pageable pageable) {
    ...
    public ResponseEntity<CurrentUserReadDto> update(
    ...
    @GetMapping("/current")
    public ResponseEntity<CurrentUserReadDto> getCurrentUser() {
